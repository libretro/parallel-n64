...
COMMON_FLAGS += -DANDROID_ARM -DDYNAREC -DNEW_DYNAREC=3 -DARM_ASM -DNO_ASM
LOCAL_ARM_MODE := arm
LOCAL_CFLAGS += -marm
...
COMMON_FLAGS += -DM64P_CORE_PROTOTYPES -D_ENDUSER_RELEASE -DM64P_PLUGIN_API -D__LIBRETRO__ -DINLINE="inline" -DNOSSE -DSDL_VIDEO_OPENGL_ES2=1 -DGLES -DANDROID -DSINC_LOWER_QUALITY -DGLES -DHAVE_LOGGER
