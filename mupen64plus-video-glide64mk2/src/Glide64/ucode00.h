...
void load_matrix (float m[4][4], uint32_t addr)
{
  ...
  addr >>= 1;
  uint16_t * src = (uint16_t*)GFX_PTR.RDRAM;
...
static void uc0_movemem()
{
  ...
  case 0x80:
    {
      ...
      int16_t scale_x = ((int16_t*)GFX_PTR.RDRAM)[(a+0)^1] / 4;
      int16_t scale_y = ((int16_t*)GFX_PTR.RDRAM)[(a+1)^1] / 4;
      int16_t scale_z = ((int16_t*)GFX_PTR.RDRAM)[(a+2)^1];
      int16_t trans_x = ((int16_t*)GFX_PTR.RDRAM)[(a+4)^1] / 4;
      int16_t trans_y = ((int16_t*)GFX_PTR.RDRAM)[(a+5)^1] / 4;
  ...
  case 0x82:
    {
      ...
      int8_t dir_x = ((int8_t*)GFX_PTR.RDRAM)[(a+8)^3];
      rdp.lookat[1][0] = (float)(dir_x) / 127.0f;
      int8_t dir_y = ((int8_t*)GFX_PTR.RDRAM)[(a+9)^3];
      rdp.lookat[1][1] = (float)(dir_y) / 127.0f;
      int8_t dir_z = ((int8_t*)GFX_PTR.RDRAM)[(a+10)^3];
  ...
  case 0x84:
    a = segoffset(rdp.cmd1) & 0x00ffffff;
    rdp.lookat[0][0] = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+8)^3]) / 127.0f;
    rdp.lookat[0][1] = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+9)^3]) / 127.0f;
    rdp.lookat[0][2] = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+10)^3]) / 127.0f;
    rdp.use_lookat = TRUE;
    FRDP("lookat_x (%f, %f, %f)\n", rdp.lookat[1][0], rdp.lookat[1][1], rdp.lookat[1][2]);
    break;
  ...
  case 0x94:
    ...
    // Get the data
    rdp.light[i].r = (float)(((uint8_t*)GFX_PTR.RDRAM)[(a+0)^3]) / 255.0f;
    rdp.light[i].g = (float)(((uint8_t*)GFX_PTR.RDRAM)[(a+1)^3]) / 255.0f;
    rdp.light[i].b = (float)(((uint8_t*)GFX_PTR.RDRAM)[(a+2)^3]) / 255.0f;
    rdp.light[i].a = 1.0f;
    // ** Thanks to Icepir8 for pointing this out **
    // Lighting must be signed byte instead of byte
    rdp.light[i].dir_x = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+8)^3]) / 127.0f;
    rdp.light[i].dir_y = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+9)^3]) / 127.0f;
    rdp.light[i].dir_z = (float)(((int8_t*)GFX_PTR.RDRAM)[(a+10)^3]) / 127.0f;
    // **
