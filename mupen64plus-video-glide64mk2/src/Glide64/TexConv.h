...
static inline void texConv_ARGB1555_ARGB4444(uint8_t *_src, uint8_t *_dst, int size)
{
#ifdef __LIBRETRO__
...
static inline void texConv_AI88_ARGB4444(uint8_t *_src, uint8_t *_dst, int size)
{
#ifdef __LIBRETRO__
  RETRO_PERFORMANCE_INIT (perf_cb, texConv_AI88_ARGB4444);
  RETRO_PERFORMANCE_START(perf_cb, texConv_AI88_ARGB4444);
  ...
  RETRO_PERFORMANCE_STOP(perf_cb, texConv_AI88_ARGB4444);
#else
  uint32_t *v3;
  uint32_t *v4;
  int v5;
...
static inline void texConv_AI44_ARGB4444(uint8_t *_src, uint8_t *_dst, int size)
{
#ifdef __LIBRETRO__
