...
static void t3dProcessRDP(uint32_t a)
{
  ...
  {
    rdp.LLE = 1;
    rdp.cmd0 = ((uint32_t*)GFX_PTR.RDRAM)[a++];
    rdp.cmd1 = ((uint32_t*)GFX_PTR.RDRAM)[a++];
    while (rdp.cmd0 + rdp.cmd1) {
      ...
      {
        rdp.cmd2 = ((uint32_t*)GFX_PTR.RDRAM)[a++];
        rdp.cmd3 = ((uint32_t*)GFX_PTR.RDRAM)[a++];
      }
    }
    rdp.LLE = 0;
  }
...
static void Turbo3D()
{
  ...
  do {
    ...
    pgstate = ((uint32_t*)GFX_PTR.RDRAM)[a>>2];
    pstate = ((uint32_t*)GFX_PTR.RDRAM)[(a>>2)+1];
    pvtx = ((uint32_t*)GFX_PTR.RDRAM)[(a>>2)+2];
    ptri = ((uint32_t*)GFX_PTR.RDRAM)[(a>>2)+3];
