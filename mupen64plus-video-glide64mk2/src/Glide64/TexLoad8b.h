...
static inline void load8bCI(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v13 = (uint32_t *)(v7 + 4);
      ALOWORD(v10) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 15) & 0x1FE)), 1);
      v14 = v10 << 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 23) & 0x1FE)), 1);
      *v8 = v14;
      v15 = v8 + 1;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v12 & 0x1FE)), 1);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 7) & 0x1FE)), 1);
      *v15 = v14;
      ++v15;
      v16 = bswap32(*v13);
      v7 = (uint8_t *)(v13 + 1);
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 15) & 0x1FE)), 1);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 23) & 0x1FE)), 1);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v16 & 0x1FE)), 1);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 7) & 0x1FE)), 1);
      *v15 = v14;
      v8 = v15 + 1;
      v10 = v11 - 1;
    }
    ...
    do
    {
      v20 = v19;
      v21 = bswap32(v17[1]);
      ALOWORD(v19) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 15) & 0x1FE)), 1);
      v22 = v19 << 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 23) & 0x1FE)), 1);
      *v18 = v22;
      v23 = v18 + 1;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v21 & 0x1FE)), 1);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 7) & 0x1FE)), 1);
      *v23 = v22;
      ++v23;
      v24 = bswap32(*v17);
      v17 = (uint32_t *)&src[((uintptr_t)v17 + 8 - (uintptr_t)src) & 0x7FF];
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 15) & 0x1FE)), 1);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 23) & 0x1FE)), 1);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v24 & 0x1FE)), 1);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 7) & 0x1FE)), 1);
      *v23 = v22;
      v18 = v23 + 1;
      v19 = v20 - 1;
    }
...
static inline void load8bIA8(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v12 = bswap32(*v7);
      v13 = v7 + 1;
      ALOWORD(v10) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 15) & 0x1FE)), 8);
      v14 = v10 << 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 23) & 0x1FE)), 8);
      *v8 = v14;
      v15 = v8 + 1;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v12 & 0x1FE)), 8);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v12 >> 7) & 0x1FE)), 8);
      *v15 = v14;
      ++v15;
      v16 = bswap32(*v13);
      v7 = v13 + 1;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 15) & 0x1FE)), 8);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 23) & 0x1FE)), 8);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v16 & 0x1FE)), 8);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v16 >> 7) & 0x1FE)), 8);
      *v15 = v14;
      v8 = v15 + 1;
      v10 = v11 - 1;
    }
    ...
    do
    {
      v20 = v19;
      v21 = bswap32(v17[1]);
      ALOWORD(v19) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 15) & 0x1FE)), 8);
      v22 = v19 << 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 23) & 0x1FE)), 8);
      *v18 = v22;
      v23 = v18 + 1;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v21 & 0x1FE)), 8);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v21 >> 7) & 0x1FE)), 8);
      *v23 = v22;
      ++v23;
      v24 = bswap32(*v17);
      v17 += 2;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 15) & 0x1FE)), 8);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 23) & 0x1FE)), 8);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + (2 * (uint16_t)v24 & 0x1FE)), 8);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16__(*(uint16_t *)((int8_t *)pal + ((v24 >> 7) & 0x1FE)), 8);
      *v23 = v22;
      v18 = v23 + 1;
      v19 = v20 - 1;
    }
