...
EXPORT int CALL videoRomOpen(void)
{
...
EXPORT int CALL videoInitiateGFX(GFX_INFO Gfx_Info)
{
...
EXPORT void CALL videoFBRead(uint32 addr)
{
...
EXPORT void CALL videoFBWrite(uint32 addr, uint32 size)
{
...
EXPORT void CALL videoReadScreen2(void *dest, int *width, int *height, int bFront)
{
...
EXPORT void CALL videoSetRenderingCallback(void (*callback)(int))
{
