...
//
//****************************************************************
static INLINE void texConv_ARGB1555_ARGB4444(uint32_t *src, uint32_t *dst, int size)
{
  do
  {
    uint32_t col = *src++;
...
static INLINE void texConv_AI88_ARGB4444(uint32_t *src, uint32_t *dst, int size)
{
  do
  {
    uint32_t col = *src++;
...
static INLINE void texConv_AI44_ARGB4444(uint32_t *src, uint32_t *dst, int size)
{
  do
  {
    uint32_t col = *src++;
...
static INLINE void texConv_A8_ARGB4444(uint32_t *src, uint32_t *dst, int size)
{
  do
  {
    uint32_t col = *src++;
...
void TexConv_ARGB1555_ARGB4444 (unsigned char * src, unsigned char * dst, int width, int height)
{
  ...
  texConv_ARGB1555_ARGB4444((uint32_t*)src, (uint32_t*)dst, size);
}
...
void TexConv_AI88_ARGB4444 (unsigned char * src, unsigned char * dst, int width, int height)
{
  ...
  // 2 pixels are converted in one loop
  // NOTE: width * height must be a multiple of 2
  texConv_AI88_ARGB4444((uint32_t*)src, (uint32_t*)dst, size);
}
...
void TexConv_AI44_ARGB4444 (unsigned char * src, unsigned char * dst, int width, int height)
{
  ...
  texConv_AI44_ARGB4444((uint32_t*)src, (uint32_t*)dst, size);
}
...
void TexConv_A8_ARGB4444 (unsigned char * src, unsigned char * dst, int width, int height)
{
  ...
  // 4 pixels are converted in one loop
  // NOTE: width * height must be a multiple of 4
  texConv_A8_ARGB4444((uint32_t*)src, (uint32_t*)dst, size);
}
