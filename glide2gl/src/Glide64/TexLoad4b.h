...
static INLINE void load4bCI(uint8_t *src, uint8_t *dst, int wid_64, int height, uint16_t line, int ext, uint16_t *pal)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v14 = v10 << 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 27) & 0x1E)), 1, NBITS_4B);
      *(uint32_t *)v8 = v14;
      v15 = (uint32_t *)(v8 + 4);
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 15) & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 19) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 7) & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 11) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint8_t)v12 & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ...
      *v15 = v14;
      ...
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 27) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 15) & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 19) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 7) & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 11) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint8_t)v16 & 0x1E)), 1, NBITS_4B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 3) & 0x1E)), 1, NBITS_4B);
      *v15 = v14;
      v8 = (uint8_t *)(v15 + 1);
      v10 = v11 - 1;
    }
    ...
    do
    {
      ...
      *v18 = v22;
      v23 = v18 + 1;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 15) & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 19) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 7) & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 11) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint8_t)v21 & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ...
      *v23 = v22;
      ...
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 27) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 15) & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 19) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 7) & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 11) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint8_t)v24 & 0x1E)), 1, NBITS_4B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 3) & 0x1E)), 1, NBITS_4B);
      *v23 = v22;
      v18 = v23 + 1;
      v19 = v20 - 1;
    }
