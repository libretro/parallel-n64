...
static INLINE void load4bCI(uint8_t *src, uint8_t *dst, int wid_64, int height, uint16_t line, int ext, uint16_t *pal)
{
   ...
   do
   {
      ...
      do
      {
         ...
         v13 = v7 + 4;
         ALOWORD(v10) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 23) & 0x1E)), 1, nbits);
         v14 = v10 << 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 27) & 0x1E)), 1, nbits);
         *(uint32_t *)v8 = v14;
         v15 = (uint32_t *)(v8 + 4);
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 15) & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 19) & 0x1E)), 1, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 7) & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 11) & 0x1E)), 1, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v12 & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 3) & 0x1E)), 1, nbits);
         *v15++ = v14;
         v16 = bswap32(*(uint32_t *)v13);
         v7 = v13 + 4;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 23) & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 27) & 0x1E)), 1, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 15) & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 19) & 0x1E)), 1, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 7) & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 11) & 0x1E)), 1, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v16 & 0x1E)), 1, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 3) & 0x1E)), 1, nbits);
         *v15 = v14;
         v8 = (uint8_t *)(v15 + 1);
         v10 = v11 - 1;
      }while ( v11 != 1 );
      ...
      do
      {
         ...
         ALOWORD(v19) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 23) & 0x1E)), 1, nbits);
         v22 = v19 << 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 27) & 0x1E)), 1, nbits);
         *v18 = v22;
         v23 = v18 + 1;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 15) & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 19) & 0x1E)), 1, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 7) & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 11) & 0x1E)), 1, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v21 & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 3) & 0x1E)), 1, nbits);
         *v23++ = v22;
         v24 = bswap32(*(uint32_t *)v17);
         v17 = (uint8_t*)(&src[((uintptr_t)v17 + 8 - (uintptr_t)src) & 0x7FF]);
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 23) & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 27) & 0x1E)), 1, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 15) & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 19) & 0x1E)), 1, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 7) & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 11) & 0x1E)), 1, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v24 & 0x1E)), 1, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 3) & 0x1E)), 1, nbits);
         *v23 = v22;
         v18 = v23 + 1;
         v19 = v20 - 1;
      }while ( v20 != 1 );
      v7 = &src[(line + (uintptr_t)v17 - (uintptr_t)src) & 0x7FF];
      v8 = (uint8_t *)((int8_t *)v18 + ext);
      v9 = v26 - 1;
   }while ( v26 != 1 );
}
...
static INLINE void load4bIAPal(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
   ...
   do
   {
      ...
      do
      {
         ...
         v12 = bswap32(*(uint32_t *)v7);
         v13 = (uint32_t *)(v7 + 4);
         ALOWORD(v10) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 23) & 0x1E)), 8, nbits);
         v14 = v10 << 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 27) & 0x1E)), 8, nbits);
         *v8 = v14;
         v15 = v8 + 1;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 15) & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 19) & 0x1E)), 8, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 7) & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 11) & 0x1E)), 8, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v12 & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v12 >> 3) & 0x1E)), 8, nbits);
         *v15++ = v14;
         v16 = bswap32(*v13);
         v7 = (uint8_t *)(v13 + 1);
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 23) & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 27) & 0x1E)), 8, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 15) & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 19) & 0x1E)), 8, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 7) & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 11) & 0x1E)), 8, nbits);
         *v15++ = v14;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v16 & 0x1E)), 8, nbits);
         v14 <<= 16;
         ALOWORD(v14) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v16 >> 3) & 0x1E)), 8, nbits);
         *v15 = v14;
         v8 = v15 + 1;
         v10 = v11 - 1;
      }while ( v11 != 1 );
      ...
      do
      {
         v20 = v19;
         v21 = bswap32(*((uint32_t *)v17 + 1));
         ALOWORD(v19) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 23) & 0x1E)), 8, nbits);
         v22 = v19 << 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 27) & 0x1E)), 8, nbits);
         *v18 = v22;
         v23 = v18 + 1;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 15) & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 19) & 0x1E)), 8, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 7) & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 11) & 0x1E)), 8, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v21 & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v21 >> 3) & 0x1E)), 8, nbits);
         *v23++ = v22;
         v24 = bswap32(*(uint32_t *)v17);
         v17 = (uint32_t*)(&src[((uintptr_t)v17 + 8 - (uintptr_t)src) & 0x7FF]);
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 23) & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 27) & 0x1E)), 8, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 15) & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 19) & 0x1E)), 8, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 7) & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 11) & 0x1E)), 8, nbits);
         *v23++ = v22;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + (2 * (uint8_t)v24 & 0x1E)), 8, nbits);
         v22 <<= 16;
         ALOWORD(v22) = __ROR16(*(uint16_t *)((int8_t *)pal + ((v24 >> 3) & 0x1E)), 8, nbits);
         *v23 = v22;
         v18 = v23 + 1;
         v19 = v20 - 1;
      }while ( v20 != 1 );
...
static INLINE void load4bIA(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext)
{
   ...
   do
   {
      ...
      if ( v57 == 1 )
         break;
      v58 = v57 - 1;
      v33 = (uint32_t *)((int8_t *)v6 + line);
      v34 = (uint32_t *)((int8_t *)v7 + ext);
      v35 = wid_64;
      do
      {
         v36 = v35;
      ...
      v6 = (uint32_t *)((int8_t *)v33 + line);
      v7 = (uint32_t *)((int8_t *)v34 + ext);
      v8 = v58 - 1;
   }while ( v58 != 1 );
}
...
static INLINE void load4bI(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext)
{
   ...
   do
   {
      ...
      if ( v33 == 1 )
         break;
      v34 = v33 - 1;
      v21 = (uint32_t *)((int8_t *)v6 + line);
      v22 = (uint32_t *)((int8_t *)v7 + ext);
      v23 = wid_64;
      do
      {
         v24 = v23;
      ...
      v6 = (uint32_t *)((int8_t *)v21 + line);
      v7 = (uint32_t *)((int8_t *)v22 + ext);
      v8 = v34 - 1;
   }while ( v34 != 1 );
}
