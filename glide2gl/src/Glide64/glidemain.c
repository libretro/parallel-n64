...
void ReadSpecialSettings (const char * name)
{
   ...
   else if (strstr(name, (const char *)"�޸�����ݾ�64"))
   {
      //fb_info_disable = 1
      //depthmode = 0
   }
   ...
   else if (strstr(name, (const char *)"����ذ�G2"))
   {
      //depthmode = 0
      smart_read = 0;
#ifdef HAVE_HWFBE
   ...
   else if (strstr(name, (const char *)"����ɾ�ı���ح��"))
   {
   ...
   else if (strstr(name, (const char*)"��״��3 �������SOS!"))
   {
         ...
         )
   {
      ...
      settings.swapmode = 0;
         ...
         //|| strstr(name, (const char*)"������\ �޴��") */ TODO: illegal characters - find by ucode CRC */
   ...
   else if (strstr(name, (const char*)"�ѽ���ɶ���64")
         )
   {
      settings.force_microcheck = 1;
      //depthmode = 0
   ...
   else if (strstr(name, (const char*)"��������64"))
   {
      //;Morita Shogi 64
      settings.correct_viewport = 1;
   }
   ...
   else if (strstr(name, (const char*)"��״�� Я�ɾ�ڲ��"))
   {
   ...
   else if (strstr(name, (const char*)"HEIWA ���ݺ ܰ���64"))
   {
   ...
   else if (strstr(name, (const char*)"�ׯĶ��� 64��ò���"))
   {
      settings.filtering = 1;
      //depthmode = 0
      settings.buff_clear = 0;
   }
   else if (strstr(name, (const char*)"���߰��ޯ�����64"))
   {
   ...
   else if (strstr(name, (const char*)"���!�����߽�����"))
   {
      settings.force_microcheck = 1;
      //depthmode = 1
      settings.fog = 0;
   ...
   else if (strstr(name, (const char*)"������Ϻޯ�ܰ���"))
   {
   ...
   // later
   else if (strstr(name, (const char*)"Jذ��\ ������ް�1997"))
   {
   ...
   else if (strstr(name, (const char*)"Ǽ���64"))
   {
      //; Nushi Zuri 64
      settings.force_microcheck = 1;
      //wrap_big_tex = 0
