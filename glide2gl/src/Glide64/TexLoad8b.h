...
static INLINE void load8bCI(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v14 = v10 << 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 23) & 0x1FE)), 1, NBITS_8B);
      *v8 = v14;
      v15 = v8 + 1;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v12 & 0x1FE)), 1, NBITS_8B);
      v14 <<= 16;
      ...
      *v15 = v14;
      ...
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 23) & 0x1FE)), 1, NBITS_8B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v16 & 0x1FE)), 1, NBITS_8B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 7) & 0x1FE)), 1, NBITS_8B);
      *v15 = v14;
      v8 = v15 + 1;
      v10 = v11 - 1;
    }
    ...
    do
    {
      ...
      *v18 = v22;
      v23 = v18 + 1;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v21 & 0x1FE)), 1, NBITS_8B);
      v22 <<= 16;
      ...
      *v23 = v22;
      ...
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 23) & 0x1FE)), 1, NBITS_8B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v24 & 0x1FE)), 1, NBITS_8B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 7) & 0x1FE)), 1, NBITS_8B);
      *v23 = v22;
      v18 = v23 + 1;
      v19 = v20 - 1;
    }
...
static INLINE void load8bIA8(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
  ...
  do
  {
    ...
    do
    {
      ...
      v14 = v10 << 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 23) & 0x1FE)), 8, NBITS_8B);
      *v8 = v14;
      v15 = v8 + 1;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v12 & 0x1FE)), 8, NBITS_8B);
      v14 <<= 16;
      ...
      *v15 = v14;
      ...
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 23) & 0x1FE)), 8, NBITS_8B);
      *v15 = v14;
      ++v15;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v16 & 0x1FE)), 8, NBITS_8B);
      v14 <<= 16;
      ALOWORD(v14) = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 7) & 0x1FE)), 8, NBITS_8B);
      *v15 = v14;
      v8 = v15 + 1;
      v10 = v11 - 1;
    }
    ...
    do
    {
      ...
      *v18 = v22;
      v23 = v18 + 1;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v21 & 0x1FE)), 8, NBITS_8B);
      v22 <<= 16;
      ...
      *v23 = v22;
      ...
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 23) & 0x1FE)), 8, NBITS_8B);
      *v23 = v22;
      ++v23;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v24 & 0x1FE)), 8, NBITS_8B);
      v22 <<= 16;
      ALOWORD(v22) = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 7) & 0x1FE)), 8, NBITS_8B);
      *v23 = v22;
      v18 = v23 + 1;
      v19 = v20 - 1;
    }
