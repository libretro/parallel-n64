...
static INLINE void load8bIA8(uint8_t *src, uint8_t *dst, int wid_64, int height, int line, int ext, uint16_t *pal)
{
   ...
   do
   {
      ...
      do
      {
         ...
         v12 = bswap32(*v7);
         v13 = v7 + 1;
         tmp = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 15) & 0x1FE)), 8);
         ALOWORD(v10) = tmp;
         v14 = v10 << 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 23) & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         *v8 = v14;
         v15 = v8 + 1;
         utmp = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v12 & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         v14 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v12 >> 7) & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         *v15 = v14;
         ++v15;
         v16 = bswap32(*v13);
         v7 = v13 + 1;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 15) & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         v14 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 23) & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         *v15 = v14;
         ++v15;
         utmp = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v16 & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         v14 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v16 >> 7) & 0x1FE)), 8);
         ALOWORD(v14) = utmp;
         *v15 = v14;
         v8 = v15 + 1;
         v10 = v11 - 1;
      ...
      do
      {
         v20 = v19;
         v21 = bswap32(v17[1]);
         tmp = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 15) & 0x1FE)), 8);
         ALOWORD(v19) = tmp;
         v22 = v19 << 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 23) & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         *v18 = v22;
         v23 = v18 + 1;
         utmp = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v21 & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         v22 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v21 >> 7) & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         *v23 = v22;
         ++v23;
         v24 = bswap32(*v17);
         v17 += 2;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 15) & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         v22 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 23) & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         *v23 = v22;
         ++v23;
         utmp = __ROR16(*(uint16_t *)((char *)pal + (2 * (uint16_t)v24 & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         v22 <<= 16;
         utmp = __ROR16(*(uint16_t *)((char *)pal + ((v24 >> 7) & 0x1FE)), 8);
         ALOWORD(v22) = utmp;
         *v23 = v22;
         v18 = v23 + 1;
         v19 = v20 - 1;
