...
void Config::resetToDefaults()
{
...
#else
	video.fullscreen = 0;
	video.fullscreenWidth = video.windowedWidth = screen_width;
#endif
	video.fullscreenHeight = video.windowedHeight = screen_height;
	...
	config.video.fullscreenWidth = screen_width;
	config.video.windowedHeight = screen_height;
