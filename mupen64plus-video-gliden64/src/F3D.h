...
extern "C" void F3D_Reserved1( uint32_t w0, uint32_t w1 );
extern "C" void F3D_Reserved2( uint32_t w0, uint32_t w1 );
extern "C" void F3D_Reserved3( uint32_t w0, uint32_t w1 );
