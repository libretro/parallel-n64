...
int read_mi_regs(struct r4300_core *r4300, uint32_t address, uint32_t* value)
{
    *value = r4300->mi.regs[MI_REG(address)];

    return 0;
}

int write_mi_regs(struct r4300_core *r4300, uint32_t address, uint32_t value, uint32_t mask)
{
