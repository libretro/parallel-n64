...
#endif
#ifdef ARCH_HAS_STORE_IMMADDR_AT_MEM_IMMADDR
	ARCH_OP_STORE_IMMADDR_AT_MEM_IMMADDR,
#endif
#ifdef ARCH_HAS_STOREADDR_REG_AT_MEM_REG
	ARCH_OP_STOREADDR_REG_AT_MEM_REG,
#endif
