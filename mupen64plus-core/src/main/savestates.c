...
int savestates_save_m64p(unsigned char *data, size_t size)
{
    ...
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x1) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x2) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x4) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x8) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x10) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x20) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x40) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x80) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x100) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x200) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x400) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x800) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x1000) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x2000) != 0);
    PUTDATA(curr, uint32_t, (g_sp_regs[SP_STATUS_REG] & 0x4000) != 0);
